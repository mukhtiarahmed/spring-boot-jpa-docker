...
import com.siroi.assignment.exception.*;
...
public final class SiroiAssignmentHelper {
	...
	public static <T extends Throwable> void logException(String signature, T e) {
		...
		if(e instanceof SiroiAssignmentException) {
	...
	public static String copyFileToDir(MultipartFile multipart, String dirPath)
		...
		if(!createDirectoryIfNotExist(dir)) {
			throw new SiroiAssignmentException("Error during to create dir : " + dirPath);
		}
		...
		try {
			...
			throw new SiroiAssignmentException("Error during copy upload file : ",  e);
		}
